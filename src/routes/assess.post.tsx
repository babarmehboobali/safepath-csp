...
export const Route = createFileRoute("/assess/post")({ component: Post });
...
function Post() {
  ...
  if (!items?.length) {
    return (
      <Shell>
        <div className="sp-wrap"><p className="sp-kicker">Post-test</p><h1 className="sp-title mt-2 text-3xl">Building sitting…</h1></div>
      </Shell>
    );
  }
  return (
    <CbtSitting
      title="Post-test · 50 items"
      items={items}

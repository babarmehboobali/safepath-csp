...
export type StudioSession = { email: string; name: string; agreed: boolean; completed: number[]; track: TrackId; industry: IndustryId; exams: ExamRecord[]; studyDates: string[]; knownCards: number[]; missed: number[]; lessons: Record<number, LessonRecord>; flaggedClasses: number[]; attempts: LearningAttempt[] };
function empty(): StudioSession { return { email: "", name: "", agreed: false, completed: [], track: "recommended", industry: "general", exams: [], studyDates: [], knownCards: [], missed: [], lessons: {}, flaggedClasses: [], attempts: [] }; }
